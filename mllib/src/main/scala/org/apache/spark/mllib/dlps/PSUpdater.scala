 ...
 */
@DeveloperApi
abstract class PSUpdater extends Serializable {
  /**
 ...
 */
//@DeveloperApi
//class PSSimpleUpdater extends PSUpdater {
 ...
 */
@DeveloperApi
class L1Updater extends PSUpdater {
  override def compute(
      weightsOld: Vector,
      gradient: Vector,
      stepSize: Double,
 ...
 */
@DeveloperApi
class SquaredL2Updater extends PSUpdater {
  override def compute(
      weightsOld: Vector,
      gradient: Vector,
      stepSize: Double,
